...
@section('title','Lista de Mis Revistas')
                ...
                <ul class="header-dropdown m-r--5">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{ route('backoffice.revista.create') }}">Subir</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
            <div class="body">
                @include('models.revista.content-index')
            </div>
        </div>
    </div>
</div>
