...
<li><a href="{{ route('backoffice.genero.index') }}">Generos</a></li>
...
<div class="row clearfix">
    <div class="col-xs-6 col-sm-offset-3">
        <div class="card">
            <div class="header">
                <h2>
                    Crear Genero <small>Los campos con * son <b>OBLIGATORIOS</b></small>
                </h2>
            </div>
            <div class="body">
                <form id="wizard_with_validation" action="{{ route('backoffice.genero.store') }}" method="POST">
                    @csrf
                    <h3>Informacion del Genero</h3>
                    <fieldset>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                <textarea name="descripcion" cols="30" rows="3" class="form-control no-resize" required></textarea>
