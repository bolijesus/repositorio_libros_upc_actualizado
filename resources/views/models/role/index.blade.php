                ...
                <ul class="header-dropdown m-r--5">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{ route('backoffice.role.create') }}">Crear</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row d-inline small clearfix">
                                        <a href="{{ route('backoffice.role.show',$role) }}" class="col-xs-offset-1 btn btn-xs bg-cyan waves-effect ">
                                            <i class="large material-icons">remove_red_eye</i>
                                        </a>
                                        <a href="{{ route('backoffice.role.edit',$role) }}" class="col-xs-offset-1 btn btn-xs bg-orange waves-effect">
