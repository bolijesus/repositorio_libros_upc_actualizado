...
<div class="row clear-fix">
    <div class="col-xs-12 col-md-6">
        ...
        <div class="form-group">
            <div class="form-line">
                <input type="text" value="{{ old('titulo', optional($tesis->bibliografia)->titulo) }}" id="titulo" name="titulo" class="form-control" 
            ...
            <div class="col-sm-12" style="margin-top: 24px;">
                ...
                <div class="form-group">
                    <select class="selects-form-bibliografia" multiple name="autores[]">
                        ...
                        <option value="{{ $autor->id }}" {{ optional($tesis->bibliografia)->hasAutor($autor) ? 'selected' : '' }}>{{ $autor->nombre }}</option>
                ...
                <div class="form-group">
                    <select class="selects-form-bibliografia" multiple name="generos[]">
                        <optgroup label="---Selecciona uno o mas Generos---">
                            ...
                            <option value="{{ $genero->id }}" {{ optional($tesis->bibliografia)->hasGenero($genero) ? 'selected' : '' }}>{{ $genero->nombre }}</option>
            ...
            <div class="col-sm-12" style="margin-top: 24px;">
                ...
                <div class="form-group">
                    <select class="selects-form-bibliografia" name="idioma">
                        <optgroup label="Elije un idioma para tu tesis">
...
<div class="row clearfix">
    <div class="col-xs-12 col-md-4">
        <label for="publicadores">publicadores*</label>
        <div class="form-group">
            <div class="form-line">
                <input type="text" value="{{ old('publicadores', $tesis->publicadores) }}" id="publicadores" name="publicadores" class="form-control"
                    placeholder="publicadores de la tesis">
            </div>
            <label id="user_name-error" class="error">{{ $errors->first('publicadores') }}</label>
        </div>
    </div>
    <div class="col-xs-12 col-md-4">
                ...
                <div class="form-group">
                    ...
                    <div class="form-line">
                        <textarea rows="4" class="form-control no-resize"
                            placeholder="Descripcion..." name="descripcion">{{ old('descripcion',optional($tesis->bibliografia)->descripcion) }}</textarea>
                    </div>
